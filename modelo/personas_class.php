 ...
 public function Registrar_persona_proyecto($data)
        ...
        public function Registrar_persona_bono($data)
    {
        ...
        try {
            ...
            $this->error = 'Ha surgido un error y no se puede cargar los datos. Detalle: ' . $e->getMessage();
            return 'Ha surgido un error y no se puede cargar los datos. Detalle: ' . $e->getMessage();
        }
    }
    ...
    public function Actualizar($data)
    {
        ...
        try {
            $query = $this->conexion->prepare("UPDATE personas  SET
                ...
                id_parto_humanizado     =:id_parto_humanizado, 
                id_transporte           =:id_transporte, 
                id_sector_agricola      =:id_sector_agricola, 
                id_comunidad_indigena   =:id_comunidad_indigena,
                id_cond_laboral         =:id_cond_laboral,
                id_org_politica         =:id_org_politica,
            ...
            $query->execute([
                ...
                'telefono'                  =>$data['telefono'],
                'correo'                    =>$data['correo'],
                'carnet_patria'             =>$data['carnet_patria'],
                ...
                'miliciano'                 =>$data['miliciano'],
                'antiguedad_comunidad'      =>$data['antiguedad_comunidad'],
                'vacuna_covid'              =>$data['vacuna_covid'],
                'fecha_vacuna'              =>$data['fecha_vacuna'],
                'nivel_educativo'           =>$data['nivel_educativo'],
                'estado'                    =>$data['estado']
