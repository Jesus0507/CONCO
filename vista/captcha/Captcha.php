<div class="col-12">
    <img style="border: 1px solid gray;width: 100%;height:20%;" id="captcha"
        src="vista/captcha/securimage/securimage_show.php" alt="CAPTCHA Image" />

    <div id="captcha_image_audio_div">
        <audio id="captcha_image_audio" preload="none" style="display: none">
            <source id="captcha_image_source_wav"
                src="vista/captcha/securimage/securimage_play.php?id=1234" type="audio/wav">
    ...
    <div id="captcha_image_audio_controls" class="row">
        <a tabindex="-1" class="captcha_play_button" style="margin-top: 5px;margin-right: 5px;margin-left: 10px; "
            href="vista/captcha/securimage/securimage_play.php?id=1234 ?>"
            onclick="return false">
            <img class="captcha_play_image" height="32" width="32"
                src="vista/captcha/securimage/images/audio_icon.png" alt="Play CAPTCHA Audio"
                style="border: 0px">
            <img class="captcha_loading_image rotating" height="32" width="32"
                src="vista/captcha/securimage/images/loading.png" alt="Loading audio"
                style="display: none">
        </a>
        ...
        <a tabindex="-1" href="javascript:void(0)" style="margin-right: 15px;"
            onclick="document.getElementById('captcha').src = 'vista/captcha/securimage/securimage_show.php?' + Math.random(); captcha_image_audioObj.refresh(); this.blur(); return false">

            <img height="32" width="32" src="vista/captcha/securimage/images/refresh.png"
    ...
    <script type="text/javascript" src="vista/captcha/securimage/securimage.js"></script>
