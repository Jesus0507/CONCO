            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <h4>
                            <?php 
                                if ($this->cantidad_personas < 10) {
                                echo "0".$this->cantidad_personas;
                                }else{
                                echo $this->cantidad_personas;
                                }  
                            ?>
                        </h4>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <h4>
                            <?php 
                                if ($this->cantidad_viviendas < 10){
                                echo "0".$this->cantidad_viviendas;
                                }else{
                                echo $this->cantidad_viviendas;
                                }  
                            ?>
                        </h4>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <h4>
                            <?php 
                                if ($this->cantidad_calles < 10) {
                                echo "0".$this->cantidad_calles;
                                }else{
                                echo $this->cantidad_calles;
                                }  
                            ?>
                        </h4>
                    </div>
