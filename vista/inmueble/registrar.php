                    ...
                    <div class="card-block">
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <div class="input-group">
                                    <input class="form-control mb-10" id="nombre_inmueble" name="datos[nombre_inmueble]"
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <div class="input-group">
                                    <input class="form-control mb-10" id="direccion" name="datos[direccion_inmueble]"
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <div class="input-group">
                                    <input list="tipo_I" id="tipo_inmueble" name="datos[tipo_inmueble]" class="form-control " placeholder="Tipo de Inmueble" />
                                    <datalist id="tipo_I">
