<head>
    ...
    <!-- Toastr -->
    <link rel="stylesheet" href="<?php echo constant('URL')?>config/plugins/toastr/toastr.min.css"> 
    <!-- Theme style -->
    <!-- DataTables -->
    <link rel="stylesheet"
        href="<?php echo constant('URL')?>config/plugins/datatables/media/js/jquery.dataTables.min.css">
    <link rel="stylesheet"
        href="<?php echo constant('URL')?>config/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet"
