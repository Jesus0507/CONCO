    ...
    <div class="modal-dialog modal-xl" style="max-width: 150vh;">
                ...
                <table style='width:100%'>
                    <tr>
                        ...
                        <td style='width:75%' rowspan='6'>
                            ...
                            <div id='panel-2' style='height:400px;overflow-y:scroll;display:none'>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <h2>
                                            Documentos
                            ...
                            <div id='panel-3' style='height:400px;overflow-y:scroll;display:none'>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <h2>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" id="correo" name="datos[correo]" placeholder="Correo" type="text">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">@</span>
                                                </div>
                                                <select class="custom-select" id="tipo_correo" name="datos[tipo_correo]">
                                    ...
                                    <div class="col-md-9 mt-2">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control mb-10" id="telefono" name="datos[telefono]" placeholder="0000-000-0000" type="number" />
                                        </div>
                            ...
                            <div id='panel-4' style='height:400px;overflow-y:scroll;display:none'>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <h2>
                            ...
                            <div id='panel-5' style='height:400px;overflow-y:scroll;display:none'>
                                <div class="row  mt-2">
                                    <div class="col-md-12 text-center mt-2">
                                        <h4>
                                            Información laboral
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <table style='width:100%'>
                                            <tr>
                                                ...
                                                <td><input type="button" id='btn_nueva_ocupacion' class='btn btn-info' value='Nueva' name=""></td>
                                            </tr>
                                        </table>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <table style='width:100%'>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control" id="sector_laboral" name="datos[sector_laboral]">
                                                    ...
                                                    <td style='display:none' id='ver_sector_formal'>
                                                        <select class="form-control" id="tipo_sector_formal" name="datos[tipo_sector_formal]">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <table style='width:100%'>
                                                <tr>
                                                    ...
                                                    <td><input type="button" id="otro_proyecto" value="Otro" class='btn btn-info'></td>
                                                    <td><input type="button" id="agregar_proyecto" value="Agregar" class='btn btn-primary'></td>
                                                </tr>
                                            </table>
                                        </div>
                            ...
                            <div id='panel-6' style='height:400px;overflow-y:scroll;'>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <h2>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <table style='width:100%'>
                                                    <tr>
                                                        <td>
                                                            <input class="form-control" id="contrasenia" name="" placeholder="Contraseña de ingreso" type="password">
                                                        </td>
                                                        <td><button type='button' class='btn btn-default' id='ver_clave'><em class='fa fa-eye'></em></button></td>
                                                    </tr>
                                                </table>
        ...
        <div class="col-md-12 ">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input class="form-control" id="confirmar" name="" placeholder="Contraseña de ingreso" type="password">
                ...
                <table style='width:100%'>
                    <tr>
                        <td>
                            ...
                            <div class="input-group">
                                <input class="form-control mb-10" id="color_fav" placeholder="Color favorito" type="text" maxlength="12" />
                            </div>
                        </td>
                        ...
                        <td>
                            ...
                            <div class="input-group">
                                <input class="form-control mb-10" id="animal_fav" placeholder="Animal favorito" type="text" maxlength="12" />
                            </div>
                        </td>
                        <td>
                            <span style='display:none;color:red' id='valid_mascota'>Ingrese el nombre de la primera mascota</span>
                            <div class="input-group">
                                <input class="form-control mb-10" id="primera_mascota" placeholder="Nombre de la primera mascota" type="text" maxlength="12" />
                            </div>
                        </td>
                    </tr>
                </table>
