...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Administracion de Calles</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo constant('URL');?>Inicio/">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo constant('URL');?>Calles/">Calles</a></li>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Consulta y Administracion de Calles</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
