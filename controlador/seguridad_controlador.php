...
class Seguridad extends Controlador 
{
    ...
    //&nbsp;&nbsp;<button onclick='modificar_permiso(`".json_encode($permisos)."`,`".$u['cedula_persona']."`)' class='btn btn-info' title='Modificar permisos de usuario y módulos' ><span class='fa fa-eye'></span></button>
   ...
   // if($this->modelo->change_roles($datos)){
   //  $listo=true;
   //     // if($datos['cambiar_permisos']=="si"){

   //     // if($this->modelo->cambiar_permisos_rol($datos)){
   //     //     $listo=true;
   //     // }
