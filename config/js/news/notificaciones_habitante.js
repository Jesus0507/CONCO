...
function getNotifications_habitante(){
  $.ajax({
              ...
              for (var i=0;i<result.length;i++){
                ...
                var mensaje=getRecortado(tipo[1]); 
                   ...
                   if(result[i]['leido']==0){
                    ...
                    cant++;
                   cuerpo+="<a title='"+tipo[1]+"' href='javascript:void(0)' class='dropdown-item' style='font-size:12px !important' onclick='setStatus(`"+result[i]['id_notificacion']+"`,`"+i+"`)'>";
                   ...
                   cuerpo+="</a><div class='dropdown-divider'></div>";
                    ...
                    cuerpo+="<a title='"+tipo[1]+"' href='javascript:void(0)' class='dropdown-item' style='background:#BFBFBF;font-size:12px !important;' onclick='setStatus(`"+result[i]['id_notificacion']+"`,`"+i+"`)'>";
                   cuerpo+=icono+" "+mensaje+span;
                   cuerpo+="</a><div class='dropdown-divider'></div>";
                   }
           ...
           setTimeout(function(){getNotifications_habitante();},5000);
}
