...
var btn_guardar=document.getElementById("guardar_familia");
...
btn_vivienda_nueva.onclick=function(){
	document.getElementById("titulo_accion_habitante").innerHTML="Registrar vivienda";
    document.getElementById("formulario_vivienda").style.display="";

    $("#formulario_vivienda").hide().fadeIn(1000);
    document.getElementById('calendario_eventos_habitante').style.display="none";
    document.getElementById("formulario-consulta-persona").style.display="none";
